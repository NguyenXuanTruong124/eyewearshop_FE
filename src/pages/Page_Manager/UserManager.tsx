  ...
  return (
    <div className="manager-content-wrapper">
      <div className="manager-content-header">
        ...
        <button className="btn-add-account" onClick={() => { setEditingUser(null); setIsReadOnly(false); setShowModal(true); }}>
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                <input disabled={isReadOnly} value={formData.fullName} onChange={e => setFormData({...formData, fullName: e.target.value})} className={isReadOnly ? "input-readonly" : ""} required />
              </div>

              <div className="form-row">
                <div className="form-group">
                  <label>Email đăng nhập</label>
                  <input disabled value={formData.email} className="input-readonly" />
                </div>
                <div className="form-group">
                  <label>Số điện thoại</label>
                  <input disabled={isReadOnly} value={formData.phoneNumber} onChange={e => setFormData({...formData, phoneNumber: e.target.value})} className={isReadOnly ? "input-readonly" : ""} />
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input disabled value={formData.gender || "Chưa cập nhật"} className="input-readonly" />
                </div>
                <div className="form-group">
                  <label>Ngày sinh</label>
                  <input disabled value={formData.dateOfBirth ? new Date(formData.dateOfBirth).toLocaleDateString('vi-VN') : "Chưa cập nhật"} className="input-readonly" />
                </div>
              </div>
